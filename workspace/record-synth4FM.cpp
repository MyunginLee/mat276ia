/*    Gamma - Generic processing library
    ...
    Example: 
    Description: Kind of toy code that I made to play with FM. 
                Might be different with the official release...
...
struct writetoFile {
    ...
    if (soundFile.channels() != 2) {
      cout << fileName << " is not a stereo file" << endl;
      exit(1);
    }
